...
import type { ResponseType } from '../../types/search'
  ...
  return (
    <div className="page search-page">
      ...
      {historyList.length ? (
        <>
          <div className="search-page-title flex-row flex-align-center">
            <span>历史搜索</span>
            <div className="iconfont close-icon" onClick={clearHistoryClick}>
              &#xe62b;
            </div>
          </div>
      ...
      {hotSearchList.length ? (
        <>
          <div className="search-page-title" style={{ marginTop: '0.18rem' }}>
            热门搜索
          </div>

...
function Category() {
  ...
  return (
    <div className="page category-page">
      <div className="category-page-header flex-row flex-center">分类</div>
      ...
      <div className="category-page-content">
        <div className="category">
          <div
            className={
              currentCategory === ''
                ? 'category-item is-active flex-row flex-center'
                : 'category-item flex-row flex-center'
            }
        ...
        <div className="category-content flex-row flex-column">
          <div className="tags flex-row">
            <div
              className={
                currentTag === '' ? 'tag-item is-active flex-row flex-center' : 'tag-item flex-row flex-center'
              }
            ...
            {tags.map((tag, index) => (
              <div
                key={index}
                className={
                  currentTag === tag ? 'tag-item is-active flex-row flex-center' : 'tag-item flex-row flex-center'
                }
          ...
          <div className="list flex-row flex-column">
            ...
            {productList.map((product) => (
              <div key={product.id} className="list-item flex-row" onClick={() => productClickHandler(product.id)}>
        ...
        <div className="cart">
          ...
          <div className="cart-count">
            ...
            <div className="cart-count-counter">
              <span className="cart-count-button" onClick={() => changeCartCount('minus')}>
                -
              </span>
              <span className="cart-count-text">{productInfo.count}</span>
              <span className="cart-count-button" onClick={() => changeCartCount('add')}>
                +
              </span>
            </div>
          </div>
          <div className="cart-btns">
            <div className="cart-btn" onClick={() => confirmCartHandler()}>
              加入购物车
            </div>

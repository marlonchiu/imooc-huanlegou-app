...
import { DetailResponseType, CartCountResponseType } from '../../types/detail'
  ...
  return (
    <div className="page detail-page">
      <div className="detail-page-header">
        <div className="iconfont back-icon" onClick={() => navigate(-1)}>
          &#xe600;
        </div>
        <span>商品详情</span>
      </div>
      ...
      <div className="docker">
        ...
        <div className="btn" onClick={() => toggleCartHandler()}>
          加入购物车
        </div>
      </div>
        ...
        <div className="cart">
          ...
          <div className="cart-count">
            ...
            <div className="cart-count-counter">
              <span className="cart-count-button" onClick={() => changeCartTempCount(cartTempCount - 1)}>
                -
              </span>
          ...
          <div className="cart-btns">
            <div className="cart-btn" onClick={() => addCartHandler()}>
              加入购物车
            </div>
          </div>
        </div>
